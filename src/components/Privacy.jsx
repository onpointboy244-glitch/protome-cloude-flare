  ...
  return (
    <div className="legal">
      <div className="legal__inner">
        ...
        <p>Protome also collects potentially personally-identifying information like Internet Protocol (IP) addresses for logged in users and for users leaving comments on blog posts. Protome only discloses logged in user and commenter IP addresses under the same circumstances that it uses and discloses personally-identifying information as described below.</p>

        <h2>2. Personally-Identifying Information</h2>
        <p>Certain visitors to Protome&apos;s websites choose to interact with Protome in ways that require Protome to gather personally-identifying information. The amount and type of information that Protome gathers depends on the nature of the interaction. For example, we ask visitors who sign up to provide a name and email address.</p>
